...
@NgModule({
  declarations: [
    AppComponent,
    AdminLayoutComponent, SessionDialogHandlerComponent,VerifyContactInfoDialogComponent,VerifyContactInfoNameChangeDialogComponent,
    AuthLayoutComponent
  ],
  imports: [
    BrowserModule,
    ...
    MatTableModule,
    MatToolbarModule,
    MatListModule,MatChipsModule,MatStepperModule,
  ...
  entryComponents: [ SessionDialogHandlerComponent, VerifyContactInfoDialogComponent,VerifyContactInfoNameChangeDialogComponent ],
