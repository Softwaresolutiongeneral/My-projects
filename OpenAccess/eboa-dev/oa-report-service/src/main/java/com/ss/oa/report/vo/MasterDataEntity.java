...
public class MasterDataEntity implements Serializable{
	...
	public MasterDataEntity(String serviceNumber, String orgName, String companymeterId, String modemNumber,
			String meterNumber, String multiplicationFactor, String meterMakeCode, String meterCt1, String meterCt2,
	...
	public MasterDataEntity(String serviceId, String serviceTypeCode, String serviceTypeName, String serviceNumber,
			String voltageCode, String voltageName) {
		super();
	...
	public MasterDataEntity(String companyId, String companyCode, String companyName, String isBuyer, String isSeller) {
		super();
	...
	public MasterDataEntity(String orgId, String orgCode, String orgName) {
		super();
		this.orgId = orgId;
	...
	public MasterDataEntity(String serviceId, String serviceTypeCode, String serviceTypeName, String serviceNumber,
			String companyId, String companyCode, String companyName, String capacity, String voltageCode,
			String voltageName, String fuelTypeCode, String fuelTypeName, String orgCode, String orgName) {
		super();
		this.serviceId = serviceId;
		this.serviceTypeCode = serviceTypeCode;
		this.serviceTypeName = serviceTypeName;
	...
	public MasterDataEntity(String serviceId, String serviceTypeCode, String serviceTypeName, String serviceNumber,
			...
			String capacity, String isBuyer, String isSeller, String substationId, String substationCode,
			String substationName, String feederId, String feederCode, String feederName, String voltageCode,
			String voltageName, String tariff, String companymeterId, String modemNumber, String meterNumber,
			String multiplicationFactor, String meterMakeCode, String fuelTypeCode, String fuelTypeName,
	...
	public String toString() {
		return "MasterDataEntity [serviceId=" + serviceId + ", serviceTypeCode=" + serviceTypeCode
				...
				+ ", orgCode=" + orgCode + ", orgName=" + orgName + ", capacity=" + capacity + ", isBuyer=" + isBuyer
				...
				+ ", feederName=" + feederName + ", voltageCode=" + voltageCode + ", voltageName=" + voltageName
				+ ", tariff=" + tariff + ", companymeterId=" + companymeterId + ", modemNumber=" + modemNumber
				+ ", meterNumber=" + meterNumber + ", multiplicationFactor=" + multiplicationFactor + ", meterMakeCode="
				+ meterMakeCode + ", fuelTypeCode=" + fuelTypeCode + ", fuelTypeName=" + fuelTypeName + ", meterCt1="
				+ meterCt1 + ", meterCt2=" + meterCt2 + ", meterCt3=" + meterCt3 + ", meterPt1=" + meterPt1
				+ ", meterPt2=" + meterPt2 + ", meterPt3=" + meterPt3 + ", typeOfSs=" + typeOfSs + ", selected="
				+ selected + "]";
	}
