...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'import-energy-charges-report', component: ImportenergychargesComponent, pathMatch: 'full'},
      {path:'generationstmt-report',component:GemerationstmtReportComponent,pathMatch:'full'},
      { path: 'meter-change-report-enterednow', component: MeterChangeReportenterednowComponent, pathMatch: 'full'},
