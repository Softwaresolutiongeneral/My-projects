...
import { ImportenergychargesComponent } from './components/import-energy-charges-report/import-energy-charges-report';
import { MeterChangeReportenterednowComponent } from './components/meter-change-report-new/meter-change-report-enterednow';
@NgModule({
  imports: [
    CommonModule,
  ...
  declarations: [
    ...
    Weg10Component,TechnicalInfo,DeleteTransactionReportComponent,TantranscoGeneratorInfo,TantranscoPaymentReport,TnercBankingReport092022,ImportenergychargesComponent,
    MeterChangeReportenterednowComponent
