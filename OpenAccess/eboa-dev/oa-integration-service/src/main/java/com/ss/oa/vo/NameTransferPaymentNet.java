...
public class NameTransferPaymentNet {
	...
	public NameTransferPaymentNet(String status, String image, String description, String code) {
		super();
		Status = status;
		this.image = image;
		Description = description;
