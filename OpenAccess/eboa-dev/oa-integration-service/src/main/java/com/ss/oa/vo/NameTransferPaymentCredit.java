...
public class NameTransferPaymentCredit {
	...
	public NameTransferPaymentCredit(String status, String image, String description, String code) {
		super();
		Status = status;
		this.image = image;
		Description = description;
	...
	public NameTransferPaymentCredit() {
		super();
