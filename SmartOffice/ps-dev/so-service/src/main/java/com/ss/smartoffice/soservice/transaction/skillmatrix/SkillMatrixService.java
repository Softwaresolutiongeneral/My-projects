...
public class SkillMatrixService {
	...
	public String fetchByTrain(@RequestBody String skillMatixHdrKey){
		  SkillMatrixResult skillResult=skillMatrixResultRepo.findAllBySkillMatrixHdrKey(skillMatixHdrKey);
		 skillResult.setIsTraining("N");
		  skillMatrixResultRepo.save(skillResult);
		  return "sucessfully train";
	}
	
	@PatchMapping("train")
	public String fetchByAll(@RequestBody String skillMatixHdrKey){
		  SkillMatrixResult skillResult=skillMatrixResultRepo.findAllBySkillMatrixHdrKey(skillMatixHdrKey);
		 skillResult.setIsTraining("Y");
		  skillMatrixResultRepo.save(skillResult);
		  return "sucessfully train";
	}
