    ...
    ngOnInit() {  
      ...
      this.activatedRoute.params.subscribe(params=>{           
        ...
        this.service.getFyYears().subscribe(x=>{ 
          ...
          for(let i = 0; i < this.fsYears.length; ++i){ 

            var startdate ; 

             if (this.fsYears[i].id == this.appraisalHdr.fyId )  

             {   startdate = this.fsYears[i].fromDt; 
                 ...
                 this.years[0] = this.datePipe.transform(startdate,'yyyy-MM-dd'); 

                 startdate=new Date(startdate.setMonth(startdate.getMonth() + 3)) 

                 this.years[1] = this.datePipe.transform(startdate,'yyyy-MM-dd'); 

                 startdate=new Date(startdate.setMonth(startdate.getMonth() + 3)) 

                 this.years[2] = this.datePipe.transform(startdate,'yyyy-MM-dd'); 

                 startdate=new Date(startdate.setMonth(startdate.getMonth() + 3)) 

                 this.years[3] = this.datePipe.transform(startdate,'yyyy-MM-dd'); 
    ...
    switch(type){ 
      ...
      case 'half-yearly':         
        ...
        for (let index = 0; index < 2; index++) {  
          ...
          reviews.reviewDt=this.years[index]; 
