...
export class LeaveReqCreatePage implements OnInit {
  ...
  todayDate: string;
  constructor(private _service: LeaveReqService, private router: Router, private _utils: UtilsService, private modalCtrl: ModalController, private alertCtrl: AlertController) { }
