...
export class ExpCreatePage implements OnInit {
  ...
  todayDate: string;
  constructor(private imagePicker: ImagePicker,private _utils: UtilsService, private readonly loadingCtrl: LoadingController,
     private camera: Camera,private File:File ,private _service: ExpClaimService, private alertCtrl: AlertController, private router: Router) { }

  ngOnInit() {
    this.todayDate = this._utils.formatDate(new Date());
    this.minDate = (new Date()).getFullYear() -1;
